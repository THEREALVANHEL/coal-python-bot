...
class Cookies(commands.Cog):
    ...
    @commands.slash_command(name="cookies", description="Check your or another user's cookie balance.")
    ...
    @commands.slash_command(name="cookiesrank", description="Check your or another user's rank in the leaderboard.")
    ...
    @commands.slash_command(name="top", description="Display the cookie leaderboard.")
    ...
    @commands.slash_command(name="addcookies", description="[Manager] Add cookies to a user.")
    ...
    @commands.slash_command(name="removecookies", description="[Manager] Remove cookies from a user.")
    ...
    @commands.slash_command(name="cookiesgiveall", description="[Manager] Give a certain number of cookies to everyone.")
    @option("amount", description="The amount of cookies to give.", type=int, required=True)
    ...
    @commands.slash_command(name="cookiesreset", description="[Manager] Reset all cookies on the server to 0.")

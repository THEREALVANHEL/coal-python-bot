...
class Moderation(commands.Cog):
    ...
    @commands.slash_command(name="warn", description="[Moderator] Warn a user.")
    ...
    @commands.slash_command(name="warnlist", description="[Moderator] Show all warnings for a user.")
    ...
    @commands.slash_command(name="removewarnlist", description="[Moderator] Remove all warnings for a user.")
